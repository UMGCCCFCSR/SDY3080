...
CBMC_Dead_Unstained <- GateExprsIterated(gs=Unstained_GatingSet, sample=1,
 gate="CordDead", excludeThese="FSC|SSC|Time|-H", inverse.transform=FALSE)
```


```{r}
#| eval: FALSE
PBMC_Unstained <- GateExprsIterated(gs=Unstained_GatingSet, sample=11,
 gate="scatter", excludeThese="FSC|SSC|Time|-H", inverse.transform=FALSE)
```

```{r}
#| eval: FALSE
PMA_Activated_Unstained <- GateExprsIterated(gs=Unstained_GatingSet, sample=12,
 gate="scatter", excludeThese="FSC|SSC|Time|-H", inverse.transform=FALSE)
```

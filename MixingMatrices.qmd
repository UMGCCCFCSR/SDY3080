...
#| eval: FALSE
CellStandin[,1] <- "" # name
CellStandin[,2] <- "" # Antigen
CellStandin[,3] <- "" # Fluorophore
...
CellStandin[,c(1,3,6)] <- UnstainedData[1]
CellStandin[,7:ncol(CellStandin)] <- UnstainedData[1]
CellStandin
```
...
```{r}
# UpdatedTemplate |> mutate(WhichRow = dplyr::row_number()) |> View()
```

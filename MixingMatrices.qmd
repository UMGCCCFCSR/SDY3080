...
```{r}
BeadsSC_GatingSet <- load_gs("outputs/BeadsSCs_GS1.gs")
```
...
```{r}
save_gs(BeadsSC_GatingSet, "outputs/BeadsSCs_GS_Amplified.gs")
```

## Load back in

```{r}
BeadsSC_GatingSet <- load_gs("outputs/BeadsSCs_GS_Amplified.gs")
```
...
```{r}
save_gs(CellsSC_GatingSet, "outputs/CellsSC_GS1_Amplified.gs")
```

## Load back in

```{r}
CellsSC_GatingSet <- load_gs("outputs/CellsSC_GS1_Amplified.gs")
```

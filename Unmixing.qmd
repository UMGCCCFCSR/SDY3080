...
```{r}
template <- KeptBeads
gs <- BeadsSC_GatingSet
subset <- "scatter"

InitialUnmixingGates <- function(template, gs, subset, minpercentile=0.90, maxpercentile=0.99){
    ...
    # Fluorophore becomes filterId
    # Detector becomes dims
    # subset indicates parent gate
    # minpercentile forms lower end of the span
    # maxpercentile forms upper end of the span
